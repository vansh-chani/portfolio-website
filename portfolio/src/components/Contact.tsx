...
export default function Contact() {
  return (
    <section id="contact" className="min-h-screen flex flex-col  items-center">
      <h1 className="heading-contact  font-jetBrains-mono text-4xl font-extrabold w-[1600px] p-4 mt-30 pb-10 text-white border-b-1 border-b-white/30 text-center">CONTACT</h1>
