    ...
    return (
        <div className={`fixed left-20 top-1/2 -translate-y-1/2 container max-w-100 mx-auto px-4 py-5 flex flex-col justify-center items-start gap-4 ${showSideNav ? " opacity-100 translate-x-0" : " opacity-0 -translate-x-10 pointer-events-none"} transition-all duration-300`}>
            <p onClick={handleClick}
                style={{
                    color: section === "introduction_section" ? "#ffffff" : "#8f8f8f",
                    fontSize: section === "introduction_section" ? "22px" : "20px"
                }}
            ...
            <p onClick={handleClick}
                style={{
                    color: section === "experience_section" ? "#ffffff" : "#8f8f8f",
                    fontSize: section === "experience_section" ? "22px" : "20px"
                }}
            ...
            <p onClick={handleClick}
                style={{
                    color: section === "education_section" ? "#ffffff" : "#8f8f8f",
                    fontSize: section === "education_section" ? "22px" : "20px"
                }}
            ...
            <p onClick={handleClick}
                style={{
                    color: section === "techSkills_section" ? "#ffffff" : "#8f8f8f",
                    fontSize: section === "techSkills_section" ? "22px" : "20px"
                }}
            ...
            <p onClick={handleClick}
                style={{
                    color: section === "certifications_section" ? "#ffffff" : "#8f8f8f",
                    fontSize: section === "certifications_section" ? "22px" : "20px"
                }}
