    ...
    return (
        <>
            <div className="animate-appear Hero flex flex-col items-center  justify-center h-full ">
                ...
                <h2 className="intro text-[14px] font-lexend font-medium md:text-2xl px-2 md:px-0 text-[#8F8F8F] max-w-[500px] text-center mt-2">Hi, I’m Vansh - a developer creating smarter solutions through code and data.</h2>
