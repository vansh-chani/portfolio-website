...
export function ResumeMobile() {
  return (
    <>
      <h1 className="heading-contact  font-jetBrains-mono text-3xl font-extrabold w-[90vw] md:w-[60vw] p-4 mt-10 pb-10 mb-10 text-white border-b-1 border-b-white/30 text-center">RESUME</h1>
      <div className="resume-mobile max-h-[520px] max-w-110 flex flex-col items-center justify-start mb-40 p-4 mx-4 pt-10 border border-white/10 rounded-[20px] 
